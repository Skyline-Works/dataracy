...
import { BarChart3, Github, Mail, Loader2, KeyRound } from 'lucide-react'
        ...
        <div className="min-h-screen flex flex-col items-center justify-center p-4 relative overflow-hidden bg-[#0f172a]">
            ...
            <div className="glass-card w-full max-w-md p-8 rounded-3xl relative z-10 border border-white/10 shadow-2xl">
                <div className="text-center mb-8">
                    ...
                    <p className="text-slate-400 text-sm">Dataracy 계정으로 로그인하세요</p>
                </div>
                ...
                <div className="relative mb-6">
                    ...
                    <div className="relative flex justify-center text-xs uppercase">
                        <span className="bg-[#131c31] px-2 text-slate-500">Or continue with</span>
                    </div>
                </div>
                ...
                <p className="text-center mt-8 text-sm text-slate-400">
                    계정이 없으신가요? <Link href="/signup" className="text-blue-400 hover:text-blue-300 font-bold ml-1">회원가입</Link>
                </p>
            </div>
        </div>
    )
