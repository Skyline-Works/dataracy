      ...
      <section className="section-padding flex-center" style={{ minHeight: '100vh', paddingTop: '160px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1, textAlign: 'center' }}>
          <div className="animate-fade-in">
            ...
            <h1 style={{ fontSize: '4.5rem', fontWeight: '800', lineHeight: '1.2', marginBottom: '24px', letterSpacing: '-1px' }}>
              데이터 분석가들이 <br />
              <span className="text-gradient">함께 성장하는 공간</span>
            </h1>

            <p style={{ fontSize: '1.25rem', color: 'var(--text-secondary)', maxWidth: '600px', margin: '0 auto 48px', lineHeight: '1.6', wordBreak: 'keep-all' }}>
              국내 최고의 데이터 전문가 커뮤니티에 참여하세요. SQL, Python, R 코드를 공유하고 피드백을 받으며 커리어를 레벨업할 수 있습니다.
            </p>

            <div className="flex-center" style={{ gap: '16px' }}>
              <Link href="/projects" className="btn btn-primary" style={{ height: '56px', padding: '0 32px', fontSize: '1.1rem' }}>
                시작하기 <ArrowRight size={20} style={{ marginLeft: '8px' }} />
              </Link>
              <Link href="#" className="btn btn-secondary" style={{ height: '56px', padding: '0 32px', fontSize: '1.1rem' }}>
                데모 보기
              </Link>
            </div>
          </div>
      ...
      <section className="section-padding">
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '60px' }}>
            <h2 style={{ fontSize: '3rem', fontWeight: '700', marginBottom: '16px' }}>인기 프로젝트</h2>
      ...
      <section className="section-padding" style={{ background: 'var(--bg-secondary)' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '80px' }}>
            <h2 style={{ fontSize: '3rem', fontWeight: '700', marginBottom: '16px' }}>왜 Dataracy인가요?</h2>
